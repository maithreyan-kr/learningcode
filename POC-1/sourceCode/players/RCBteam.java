...
public class RCBteam {
	...
	public static void main(String[] args)  
	{
		try
		{
		FileWriter fw= new FileWriter("RCB.txt");
	    ...
	    System.out.println("Score of RCB");
	    String sql="select TeamId ,TeamName ,PlayerName, Score from scores WHERE TeamName='RCB' ORDER BY Score ASC";
