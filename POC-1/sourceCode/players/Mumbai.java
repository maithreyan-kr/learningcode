...
public class Mumbai {
	...
	public static void main(String[] args)  
	{
		try
		{
		FileWriter fw= new FileWriter("MIteam.txt");
	    ...
	    System.out.println("Score of MI");
	    String sql="select TeamId ,TeamName ,PlayerName, Score from scores WHERE TeamName='MI' ORDER BY Score ASC";
